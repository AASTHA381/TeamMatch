...
- The Firestore database is intentionally open-read (so matching works for everyone) with a lightweight write-code as a spam/vandalism deterrent — see `firestore.rules`
...
- Firebase Firestore for the shared, real-time database
